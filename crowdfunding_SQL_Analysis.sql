...
SELECT contacts.first_name, contacts.last_name, contacts.email, (campaign.goal-campaign.pledged) 
...
campaign.company_name, campaign.description, campaign.end_date,
